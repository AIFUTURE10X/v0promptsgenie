/**
 * Long-Sleeve Shirt Mockup Configuration
 */

import type { MockupConfig, ProductColor, DrawShapeFunction } from '../generic/mockup-types'
import { LongSleeveShape, drawLongSleeveToCanvas } from '../shapes/LongSleeveShape'

export const LONGSLEEVE_COLORS: ProductColor[] = [
...
export const longsleeveConfig: MockupConfig = {
  id: 'longsleeve',
  ...
  shapeComponent: LongSleeveShape,

  exportConfig: {
    drawShape: drawLongSleeveToCanvas as DrawShapeFunction,
    yOffset: 100,
    scale: 2,
  },
